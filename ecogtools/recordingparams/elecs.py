...
def electrode_locs(patientID):
    ...
    if patientID == 'EC77':
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('ITG', 'ITG', 6), ('pos Temporal', 'pTC', 6), ('ant ST', 'aSTC', 4), (
            'mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), ('INS', 'INS', 4), ('sup CIN', 'sCIN', 4), ('inf CIN', 'iCIN', 4), ('Amygdala', 'AM', 4), ('Hippocampus', 'HPC', 4)]
        nElecsTot = 116

    elif (patientID == 'EC79'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('right Temporal', 'rTC', 4), ('ant ST', 'aSTC', 4), ('mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), (
            'ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('Amygdala', 'AM', 4), ('Hippocampus', 'HPC', 4), ('sup CIN', 'sCIN', 4), ('inf CIN', 'iCIN', 4), ('INS', 'INS', 4)]
        nElecsTot = 108

    elif (patientID == 'EC80'):
        regions_nElecs = [('Amygdala', 'AM', 10), ('ER-ctx', 'ERC', 10), ('Hipp-head', 'vHPC', 10), ('Hipp-body', 'mHPC', 10), ('Hipp-tail', 'dHPC', 10), ('Cuneus',
                                                                                                                                                           'CUN', 10), ('Calcarine', 'CAL', 10), ('inf CIN', 'iCIN', 10), ('INS', 'INS', 10), ('sup CIN', 'sCIN', 10), ('OFC', 'OFC', 10), ('Lingual-gyrus', 'LGY', 10)]
        nElecsTot = 120
        ...
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('ant Frontal', 'aFC', 20), ('ant Hipp', 'AM', 4), ('pos Hipp', 'HPC', 4), ('ant ST', 'aSTC', 4), (
            'mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), ('ITG', 'ITG', 6), ('ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('mid Frontal', 'mFC', 4)]
        nElecsTot = 122

    elif patientID == 'EC84':
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('ant Temporal', 'aTC', 20), ('ITG', 'ITG', 6), ('mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), (
            'ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('sup CIN', 'sCIN', 4), ('inf CIN', 'iCIN', 4), ('INS', 'INS', 4), ('ant MES', 'AM', 4), ('pos MES', 'HPC', 4)]
        nElecsTot = 126

    elif (patientID == 'EC108'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('OFC grid', 'OFC_G', 32), ('dl frontal grid', 'dlFC_G', 32), ('temporal pole', 'TP', 6), (
            'mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), ('ITG', 'ITG', 6), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('INS', 'INS', 10), ('CIN', 'CIN', 10)]
        nElecsTot = 188

    elif (patientID == 'EC113'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('inf temp gyrus', 'iTGY', 6), ('Amygdala', 'AM', 4), ('Hippocampus', 'HPC', 4), (
            'ant ST',  'aSTC', 6), ('mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), ('INS', 'INS', 10), ('OFC grid', 'OFC_G', 64), ('lat temp grid', 'lTC_G', 20)]
        nElecsTot = 186

    elif (patientID == 'EC122'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('temporal pole', 'TP', 6), ('ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4),
                          ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('INS', 'INS', 10), ('Heschls', 'HES', 10), ('OFC', 'OFC', 4)]
        nElecsTot = 122

    elif (patientID == 'EC125'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('INS', 'INS', 10), ('Amygdala', 'AM', 10), ('sup CIN', 'sCIN', 10), ('Hippocampus', 'HPC', 10), ('inf CIN', 'iCIN', 10), (
            'ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('ant ST', 'aSTC', 4), ('mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), ('temporal pole', 'TP', 6), ('inf temp gyrus', 'iTGY', 6)]
        nElecsTot = 146

    elif (patientID == 'EC129'):
        regions_nElecs = [('Subdural grid1', 'lFC_G', 32), ('Subdural grid2', 'lTC_G', 32), ('inf frontal pole', 'iFP', 6), ('sup frontal pole', 'sFP', 6), ('ant frontal interhemipsheric', 'aFIH', 6), ('pos frontal interhemipsheric', 'pFIH', 6), ('ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4),
                          ('temporal pole', 'TP', 6), ('ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), ('Amygdala', 'AM', 4), ('Hippocampus', 'HPC', 4), ('inf CIN', 'iCIN', 4), ('sup CIN', 'sCIN', 4), ('INS', 'INS', 10), ('parietal A', 'par A', 6), ('parietal B', 'par B', 6), ('sup frontal', 'sFC', 6)]
        nElecsTot = 154

    elif (patientID == 'EC131'):
        regions_nElecs = [('Frontal grid', 'FC_G', 32), ('Temporal grid', 'TC_G', 32), ('temporal pole', 'TP', 6), ('ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), (
            'Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('INS', 'INS', 10), ('ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('inf CIN', 'iCIN', 10), ('sup CIN', 'sCIN', 10)]
        nElecsTot = 136

    elif (patientID == 'EC133'):
        regions_nElecs = [('Temporal grid', 'TC_G', 32), ('Frontal grid', 'FC_G', 32), ('ant temporal pole', 'aTP', 6), ('ant ST', 'aSTC', 4), ('mid ST', 'mSTC', 4), (
            'pos ST', 'pSTC', 4), ('ITG', 'ITG', 6), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('CIN', 'CIN', 10), ('INS', 'INS', 10), ('OFC grid', 'OFC_G', 64)]
        nElecsTot = 192

    elif (patientID == 'EC136'):
        regions_nElecs = [('Temporal grid', 'TC_G', 32), ('Frontal grid', 'FC_G', 32), ('OFC grid', 'OFC_G', 64), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('temporal pole', 'TP', 4), (
            'ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), ('inf lat frontal', 'ilFC', 6), ('sup lat frontal', 'slFC', 6), ('inf CIN', 'iCIN', 10), ('sup CIN', 'sCIN', 10), ('INS', 'INS', 10)]
        nElecsTot = 202

    elif (patientID == 'EC139'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('lat temporal A', 'lTC A', 6), ('lat temporal B',
                                                                                                                                                'lTC B', 6), ('INS', 'INS', 10), ('sup CIN', 'sCIN', 10), ('inf CIN', 'iCIN', 10), ('OFC', 'OFC', 4), ('ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4)]
        nElecsTot = 138

    elif (patientID == 'EC142'):
        regions_nElecs = [('Frontal grid', 'FC_G', 32), ('Temporal grid', 'TC_G', 32), ('Frontal pole', 'FP', 6), ('ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('Temporal pole', 'TP', 6), ('ant ST', 'aSTC', 4),
                          ('mid ST', 'mSTC', 4), ('pos ST', 'pSTC', 4), ('ITG', 'ITG', 6), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('ven CIN', 'iCIN', 10), ('dor CIN', 'sCIN', 10), ('INS', 'INS', 10)]
        nElecsTot = 152

    elif (patientID == 'EC143'):
        regions_nElecs = [('Intrasylvian grid', 'IS_G', 32), ('Temporal grid', 'TC_G', 32), ('Frontal grid', 'FC_G', 32), ('INS', 'INS', 4), (
            'Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('OFC', 'OFC', 4), ('Temporal pole', 'TP', 6), ('ant ST', 'aSTC', 4), ('mid ST', 'mSTC', 4)]
        nElecsTot = 138

    elif (patientID == 'EC148'):
        regions_nElecs = [('Subdural grid', 'lFTC_G', 64), ('sup Frontal', 'sFC', 4), ('mid Frontal', 'mFC', 6), ('inf Frontal', 'iFC', 6), ('Frontal pole', 'FP', 6), ('ant OFC', 'aOFC', 4), (
            'pos OFC', 'pOFC', 4), ('ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('INS', 'INS', 10), ('ven CIN', 'iCIN', 10), ('dor CIN', 'sCIN', 10)]
        nElecsTot = 152

    elif (patientID == 'EC153'):
        regions_nElecs = [('Frontal grid', 'FC_G', 32), ('Temporal grid', 'TC_G', 32), ('ant OFC', 'aOFC', 4), ('pos OFC', 'pOFC', 4), ('temporal pole', 'TP', 6), (
            'ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('INS', 'INS', 10), ('ven CIN', 'iCIN', 10), ('dor CIN', 'sCIN', 10)]
        nElecsTot = 136

    elif (patientID == 'EC155'):
        regions_nElecs = [('Frontal grid', 'FC_G', 32), ('Temporal grid', 'TC_G', 32), ('ITG', 'ITG', 6), ('OFC', 'OFC', 4), ('temporal pole', 'TP', 6), (
            'ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), ('Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('INS', 'INS', 10), ('CIN', 'CIN', 8)]
        nElecsTot = 126

    elif (patientID == 'EC156'):
        regions_nElecs = [('Frontal grid', 'FC_G', 32), ('Temporal grid', 'TC_G', 32), ('OFC', 'OFC', 4), ('temporal pole', 'TP', 6), ('inf temp gyrus', 'iTGY', 4), (
            'ant ST', 'aSTC', 4), ('pos ST', 'pSTC', 4), ('Hippocampus', 'HPC', 10), ('Amygdala', 'AM', 10), ('INS', 'INS', 10), ('ven CIN', 'iCIN', 10), ('dor CIN', 'sCIN', 10)]
        nElecsTot = 136

    elif (patientID == 'EC158'):
        regions_nElecs = [('sup frontal A', 'sFC_A', 10), ('sup frontal B', 'sFC_B', 10), ('sup frontal C', 'sFC_C', 10), ('CIN', 'CIN', 10), (
            'Amygdala', 'AM', 10), ('Hippocampus', 'HPC', 10), ('lat frontal A', 'lFC_A', 4), ('lat frontal B', 'lFC_B', 4), ('OFC', 'OFC', 10)]
        nElecsTot = 78
...
def electrode_locs_dataframe(patientID):
    ...
    for abbr, region in brainRegions_map.items():
        ...
        dfRow.append({'region': region, 'abbr': abbr,
...
def choose_electrodes(patientID, abbrs, no64Grid=False, excludeGrids=False, abbrKey=True):
    ...
    brainRegions_map_inverted = dict((v, k)
                                     for k, v in brainRegions_map.items())
